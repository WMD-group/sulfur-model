...
def reference_energy(db_file, units='eV'):
    """
    Calculate energy offset between ab initio calculations and ground state, using experimental formation enthalpy of S8.
